...
*/
var enter = document.querySelector('.cards');

_axios.default.get('https://api.github.com/users/mtoricruz').then(function (response) {
...
function gitCard(object) {
  ...
  cardLocation.textContent = "Location: ".concat(object.location);
  cardProfile.textContent = "Profile: ".concat(object.url);
  ...
  cardImg.src = "".concat(object.avatar_url); // set profile link for user
